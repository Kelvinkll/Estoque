...
if(isset($_POST['enviar'])) {
    ...
    if(count($erro) == 0) {
        ...
        $mysqli->query($sql_code) or die($mysql->error);
                        ...
                        <div class="row">
                            ...
                            <div class="col-lg-4">
                                <div class="form-group">
                                    ...
                                    <input type="email" value="<?php echo $usuario['email']; ?>" name = 'email'class="form-control">
                                </div>
                            </div>
                            ...
                            <div class="col-lg-4">
                                <div class="form-group">
                                    ...
                                    <input type="text" value="<?php echo $usuario['telefone']; ?>" name = 'telefone'class="form-control">
                                </div>
                            </div>
                            ...
                            <div class="col-lg-4">
                                <div class="form-group">
                                    ...
                                    <input type="text" value="<?php echo $usuario['cargo']; ?>" name = 'cargo'class="form-control">
                                </div>
                            </div>
                            ...
                            <div class="col-lg-4">
                                <div class="form-group">
                                    ...
                                    <select name="desabilitado" class="form-control">
                                        ...
                                        <option <?php if($usuario['desabilitado']) echo 'selected'; ?> value="1">Sim</option>
                                    </select>
                                </div>  
                            </div>
